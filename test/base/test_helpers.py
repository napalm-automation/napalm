...
class TestBaseHelpers(unittest.TestCase):
    ...
    def test_load_template(self):
        ...
        _NTP_PEERS_LIST = ["172.17.17.1", "172.17.17.2"]
        _TEMPLATE_VARS = {"peers": _NTP_PEERS_LIST}
        ...
        self.assertTrue(
            napalm.base.helpers.load_template(
                self.network_driver, "__empty_template__", **_TEMPLATE_VARS
            )
        )
        ...
        self.assertTrue(
            napalm.base.helpers.load_template(
                self.network_driver, "__a_very_nice_template__", **_TEMPLATE_VARS
            )
        )
    ...
    def test_textfsm_extractor(self):
        ...
        self.assertIsInstance(
            napalm.base.helpers.textfsm_extractor(
                self.network_driver, "__a_very_nice_template__", _TEXTFSM_TEST_STRING
            ),
            list,
        )
