...
class IOSXRDriver(NetworkDriver):
    ...
    def get_interfaces(self):
        ...
        for interface_tree in interfaces_rpc_reply.xpath(
            ...
            is_l2_transport_enabled = napalm.base.helpers.find_txt(
                interface_tree, "IsL2TransportEnabled"
            )
            encapsulation = napalm.base.helpers.find_txt(
                interface_tree, "Encapsulation"
            )
            encapsulation_type = napalm.base.helpers.find_txt(
                interface_tree, "EncapsulationTypeString"
            )
            interface_type = napalm.base.helpers.find_txt(
                interface_tree, "InterfaceType"
            )
