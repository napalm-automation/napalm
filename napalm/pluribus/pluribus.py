...
class PluribusDriver(NetworkDriver):
    ...
    def open(self):
        try:
            ...
            raise napalm.base.exceptions.ConnectionException(connerr.message)
    ...
    def get_lldp_neighbors_detail(self, interface=''):
        ...
        for line in lines:
            ...
            if interface and port != interface:
                continue
            chassis = napalm.base.helpers.convert(
                    napalm.base.helpers.mac, neighbor_details[2].strip())
            port_id = py23_compat.text_type(neighbor_details[3].strip())
    ...
    def get_ntp_servers(self):
        ...
        return {
            napalm.base.helpers.convert(napalm.base.helpers.ip, ntp_peer.get('remote')): {}
        ...
        for line in traceroute_raw_output.splitlines():
            ...
            for probe_index in range(probes):
                ...
                ip_address = napalm.base.helpers.convert(
                        napalm.base.helpers.ip, hop_details[4+probe_index*5])
