...
class actions(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__config','__state','__igp_actions',)
...
apply to multiple IGPs
  ...
  _pyangbind_elements = {'config': config, 'state': state, 'igp_actions': igp_actions, }
