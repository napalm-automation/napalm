...
class config(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__neighbor_set = YANGDynClass(base=ReferenceType(referenced_path='/routing-policy/defined-sets/neighbor-sets/neighbor-set/neighbor-set-name', caller=self._path() + ['neighbor-set'], path_helper=self._path_helper, require_instance=True), is_leaf=True, yang_name="neighbor-set", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/routing-policy', defining_module='openconfig-routing-policy', yang_type='leafref', is_config=True)
...
not supported)
  ...
  neighbor_set = property(_get_neighbor_set, _set_neighbor_set)
