...
definitions
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__neighbor_set = YANGDynClass(base=YANGListType("neighbor_set_name",neighbor_set.neighbor_set, yang_name="neighbor-set", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='neighbor-set-name'), is_container='list', yang_name="neighbor-set", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/routing-policy', defining_module='openconfig-routing-policy', yang_type='list', is_config=True)
