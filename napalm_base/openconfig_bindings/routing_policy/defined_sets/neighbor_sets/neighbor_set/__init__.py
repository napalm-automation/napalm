...
class neighbor_set(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__neighbor_set_name','__config','__state',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__neighbor_set_name = YANGDynClass(base=ReferenceType(referenced_path='../config/neighbor-set-name', caller=self._path() + ['neighbor-set-name'], path_helper=self._path_helper, require_instance=True), is_leaf=True, yang_name="neighbor-set-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/routing-policy', defining_module='openconfig-routing-policy', yang_type='leafref', is_config=True)
  ...
  def _get_neighbor_set_name(self):
    """
    Getter method for neighbor_set_name, mapped from YANG variable /routing_policy/defined_sets/neighbor_sets/neighbor_set/neighbor_set_name (leafref)
  ...
  def _set_neighbor_set_name(self, v, load=False):
    """
    Setter method for neighbor_set_name, mapped from YANG variable /routing_policy/defined_sets/neighbor_sets/neighbor_set/neighbor_set_name (leafref)
    ...
    try:
      ...
      raise ValueError({
          'error-string': """neighbor_set_name must be of a type compatible with leafref""",
  ...
  _pyangbind_elements = {'neighbor_set_name': neighbor_set_name, 'config': config, 'state': state, }
