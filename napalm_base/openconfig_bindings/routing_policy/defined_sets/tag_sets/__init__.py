...
class tag_sets(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__tag_set = YANGDynClass(base=YANGListType("tag_set_name",tag_set.tag_set, yang_name="tag-set", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='tag-set-name'), is_container='list', yang_name="tag-set", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/routing-policy', defining_module='openconfig-routing-policy', yang_type='list', is_config=True)
  ...
  tag_set = property(_get_tag_set, _set_tag_set)
