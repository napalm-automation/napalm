...
class config(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__tag_set_name = YANGDynClass(base=unicode, is_leaf=True, yang_name="tag-set-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/routing-policy', defining_module='openconfig-routing-policy', yang_type='string', is_config=True)
  ...
  def _get_tag_set_name(self):
    """
    Getter method for tag_set_name, mapped from YANG variable /routing_policy/defined_sets/tag_sets/tag_set/config/tag_set_name (string)
...
the set in match conditions
  ...
  def _set_tag_set_name(self, v, load=False):
    """
    Setter method for tag_set_name, mapped from YANG variable /routing_policy/defined_sets/tag_sets/tag_set/config/tag_set_name (string)
...
the set in match conditions
    """
    try:
      t = YANGDynClass(v,base=unicode, is_leaf=True, yang_name="tag-set-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/routing-policy', defining_module='openconfig-routing-policy', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """tag_set_name must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=unicode, is_leaf=True, yang_name="tag-set-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/routing-policy', defining_module='openconfig-routing-policy', yang_type='string', is_config=True)""",
        })
  ...
  tag_value = property(_get_tag_value, _set_tag_value)
