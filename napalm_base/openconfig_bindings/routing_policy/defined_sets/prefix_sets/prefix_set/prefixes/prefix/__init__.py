...
class prefix(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__masklength_range = YANGDynClass(base=ReferenceType(referenced_path='../config/masklength-range', caller=self._path() + ['masklength-range'], path_helper=self._path_helper, require_instance=True), is_leaf=True, yang_name="masklength-range", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/routing-policy', defining_module='openconfig-routing-policy', yang_type='leafref', is_config=True)
    self.__ip_prefix = YANGDynClass(base=ReferenceType(referenced_path='../config/ip-prefix', caller=self._path() + ['ip-prefix'], path_helper=self._path_helper, require_instance=True), is_leaf=True, yang_name="ip-prefix", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/routing-policy', defining_module='openconfig-routing-policy', yang_type='leafref', is_config=True)
