...
'discontinuity-time'.
  ...
  def _set_in_octets(self, v, load=False):
    """
    Setter method for in_octets, mapped from YANG variable /interfaces/interface/state/counters/in_octets (yang:counter64)
...
'discontinuity-time'.
  ...
  def _set_in_unicast_pkts(self, v, load=False):
    """
    Setter method for in_unicast_pkts, mapped from YANG variable /interfaces/interface/state/counters/in_unicast_pkts (yang:counter64)
    If this variable is read-only (config: false) in the
...
'discontinuity-time'.
  ...
  def _set_in_broadcast_pkts(self, v, load=False):
    """
    Setter method for in_broadcast_pkts, mapped from YANG variable /interfaces/interface/state/counters/in_broadcast_pkts (yang:counter64)
    If this variable is read-only (config: false) in the
...
'discontinuity-time'.
  ...
  def _set_in_multicast_pkts(self, v, load=False):
    """
    Setter method for in_multicast_pkts, mapped from YANG variable /interfaces/interface/state/counters/in_multicast_pkts (yang:counter64)
    If this variable is read-only (config: false) in the
...
'discontinuity-time'.
  ...
  def _set_in_discards(self, v, load=False):
    """
    Setter method for in_discards, mapped from YANG variable /interfaces/interface/state/counters/in_discards (yang:counter64)
    If this variable is read-only (config: false) in the
...
'discontinuity-time'.
  ...
  def _get_in_errors(self):
    """
    Getter method for in_errors, mapped from YANG variable /interfaces/interface/state/counters/in_errors (yang:counter64)
...
'discontinuity-time'.
  ...
  def _set_in_errors(self, v, load=False):
    """
    Setter method for in_errors, mapped from YANG variable /interfaces/interface/state/counters/in_errors (yang:counter64)
    If this variable is read-only (config: false) in the
...
'discontinuity-time'.
  ...
  def _get_in_unknown_protos(self):
    """
    Getter method for in_unknown_protos, mapped from YANG variable /interfaces/interface/state/counters/in_unknown_protos (yang:counter32)
...
'discontinuity-time'.
  ...
  def _set_in_unknown_protos(self, v, load=False):
    """
    Setter method for in_unknown_protos, mapped from YANG variable /interfaces/interface/state/counters/in_unknown_protos (yang:counter32)
    If this variable is read-only (config: false) in the
...
'discontinuity-time'.
  ...
  def _set_out_octets(self, v, load=False):
    """
    Setter method for out_octets, mapped from YANG variable /interfaces/interface/state/counters/out_octets (yang:counter64)
    If this variable is read-only (config: false) in the
...
'discontinuity-time'.
  ...
  def _set_out_unicast_pkts(self, v, load=False):
    """
    Setter method for out_unicast_pkts, mapped from YANG variable /interfaces/interface/state/counters/out_unicast_pkts (yang:counter64)
    If this variable is read-only (config: false) in the
...
'discontinuity-time'.
  ...
  def _set_out_broadcast_pkts(self, v, load=False):
    """
    Setter method for out_broadcast_pkts, mapped from YANG variable /interfaces/interface/state/counters/out_broadcast_pkts (yang:counter64)
    If this variable is read-only (config: false) in the
...
'discontinuity-time'.
  ...
  def _get_out_multicast_pkts(self):
    """
    Getter method for out_multicast_pkts, mapped from YANG variable /interfaces/interface/state/counters/out_multicast_pkts (yang:counter64)
...
'discontinuity-time'.
  ...
  def _set_out_multicast_pkts(self, v, load=False):
    """
    Setter method for out_multicast_pkts, mapped from YANG variable /interfaces/interface/state/counters/out_multicast_pkts (yang:counter64)
    If this variable is read-only (config: false) in the
...
'discontinuity-time'.
  ...
  def _set_out_discards(self, v, load=False):
    """
    Setter method for out_discards, mapped from YANG variable /interfaces/interface/state/counters/out_discards (yang:counter64)
    If this variable is read-only (config: false) in the
...
'discontinuity-time'.
  ...
  def _set_out_errors(self, v, load=False):
    """
    Setter method for out_errors, mapped from YANG variable /interfaces/interface/state/counters/out_errors (yang:counter64)
    If this variable is read-only (config: false) in the
...
cleared.
  ...
  def _set_last_clear(self, v, load=False):
    """
    Setter method for last_clear, mapped from YANG variable /interfaces/interface/state/counters/last_clear (yang:date-and-time)
    If this variable is read-only (config: false) in the
