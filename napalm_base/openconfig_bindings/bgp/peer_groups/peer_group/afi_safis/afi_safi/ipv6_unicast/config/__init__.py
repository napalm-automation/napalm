...
AFI-SAFI options
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'bgp', u'peer-groups', u'peer-group', u'afi-safis', u'afi-safi', u'ipv6-unicast', u'config']
  ...
  send_default_route = property(_get_send_default_route, _set_send_default_route)
