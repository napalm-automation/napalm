...
class config(PybindBase):
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'bgp', u'peer-groups', u'peer-group', u'afi-safis', u'afi-safi', u'use-multiple-paths', u'ebgp', u'config']
...
BGP multipath. The default is use a single path.
  ...
  maximum_paths = property(_get_maximum_paths, _set_maximum_paths)
