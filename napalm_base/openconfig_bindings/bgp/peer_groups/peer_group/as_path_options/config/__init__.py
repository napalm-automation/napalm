...
for the BGP peer or group
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'bgp', u'peer-groups', u'peer-group', u'as-path-options', u'config']
...
with the local autonomous system number
  ...
  allow_own_as = property(_get_allow_own_as, _set_allow_own_as)
  replace_peer_as = property(_get_replace_peer_as, _set_replace_peer_as)
