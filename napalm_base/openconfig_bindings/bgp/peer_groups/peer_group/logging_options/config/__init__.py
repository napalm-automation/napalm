...
for events relating to the BGP neighbor or group
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'bgp', u'peer-groups', u'peer-group', u'logging-options', u'config']
...
to enable logging of peer state changes.
  ...
  log_neighbor_state_changes = property(_get_log_neighbor_state_changes, _set_log_neighbor_state_changes)
