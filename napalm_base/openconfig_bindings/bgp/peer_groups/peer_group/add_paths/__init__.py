...
class add_paths(PybindBase):
  ...
  from YANG module openconfig-bgp - based on the path /bgp/peer-groups/peer-group/add-paths. Each member element of
...
multiple paths for a single NLRI (add-paths)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'bgp', u'peer-groups', u'peer-group', u'add-paths']

  def _get_config(self):
    """
    Getter method for config, mapped from YANG variable /bgp/peer_groups/peer_group/add_paths/config (container)
  ...
  def _set_config(self, v, load=False):
    """
    Setter method for config, mapped from YANG variable /bgp/peer_groups/peer_group/add_paths/config (container)
  ...
  def _get_state(self):
    """
    Getter method for state, mapped from YANG variable /bgp/peer_groups/peer_group/add_paths/state (container)
  ...
  def _set_state(self, v, load=False):
    """
    Setter method for state, mapped from YANG variable /bgp/peer_groups/peer_group/add_paths/state (container)
    If this variable is read-only (config: false) in the
