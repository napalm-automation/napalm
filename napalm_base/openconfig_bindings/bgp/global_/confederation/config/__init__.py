...
class config(PybindBase):
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'bgp', u'global', u'confederation', u'config']

  def _get_enabled(self):
    """
    Getter method for enabled, mapped from YANG variable /bgp/global/confederation/config/enabled (boolean)
...
the local-AS is part of a BGP confederation
  ...
  def _set_enabled(self, v, load=False):
    """
    Setter method for enabled, mapped from YANG variable /bgp/global/confederation/config/enabled (boolean)
...
the local-AS is part of a BGP confederation
  ...
  def _get_identifier(self):
    """
    Getter method for identifier, mapped from YANG variable /bgp/global/confederation/config/identifier (inet:as-number)
  ...
  def _set_identifier(self, v, load=False):
    """
    Setter method for identifier, mapped from YANG variable /bgp/global/confederation/config/identifier (inet:as-number)
    If this variable is read-only (config: false) in the
  ...
  def _get_member_as(self):
    """
    Getter method for member_as, mapped from YANG variable /bgp/global/confederation/config/member_as (inet:as-number)
...
as part of the local confederation.
  ...
  def _set_member_as(self, v, load=False):
    """
    Setter method for member_as, mapped from YANG variable /bgp/global/confederation/config/member_as (inet:as-number)
    If this variable is read-only (config: false) in the
...
as part of the local confederation.
  ...
  member_as = property(_get_member_as, _set_member_as)
