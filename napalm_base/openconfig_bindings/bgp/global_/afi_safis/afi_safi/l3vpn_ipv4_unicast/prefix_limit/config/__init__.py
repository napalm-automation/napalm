...
limit for the AFI-SAFI
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'bgp', u'global', u'afi-safis', u'afi-safi', u'l3vpn-ipv4-unicast', u'prefix-limit', u'config']
...
from the neighbour
  ...
  def _get_shutdown_threshold_pct(self):
    """
    Getter method for shutdown_threshold_pct, mapped from YANG variable /bgp/global/afi_safis/afi_safi/l3vpn_ipv4_unicast/prefix_limit/config/shutdown_threshold_pct (oc-types:percentage)
...
max-prefixes
  ...
  def _set_shutdown_threshold_pct(self, v, load=False):
    """
    Setter method for shutdown_threshold_pct, mapped from YANG variable /bgp/global/afi_safis/afi_safi/l3vpn_ipv4_unicast/prefix_limit/config/shutdown_threshold_pct (oc-types:percentage)
    If this variable is read-only (config: false) in the
