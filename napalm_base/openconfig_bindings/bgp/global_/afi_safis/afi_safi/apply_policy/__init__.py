...
class apply_policy(PybindBase):
  ...
  from YANG module openconfig-bgp - based on the path /bgp/global/afi-safis/afi-safi/apply-policy. Each member element of
...
depending on the context.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'bgp', u'global', u'afi-safis', u'afi-safi', u'apply-policy']

  def _get_config(self):
    """
    Getter method for config, mapped from YANG variable /bgp/global/afi_safis/afi_safi/apply_policy/config (container)
  ...
  def _set_config(self, v, load=False):
    """
    Setter method for config, mapped from YANG variable /bgp/global/afi_safis/afi_safi/apply_policy/config (container)
  ...
  def _get_state(self):
    """
    Getter method for state, mapped from YANG variable /bgp/global/afi_safis/afi_safi/apply_policy/state (container)
  ...
  def _set_state(self, v, load=False):
    """
    Setter method for state, mapped from YANG variable /bgp/global/afi_safis/afi_safi/apply_policy/state (container)
    If this variable is read-only (config: false) in the
