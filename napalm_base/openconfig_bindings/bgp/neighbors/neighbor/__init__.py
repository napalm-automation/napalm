...
uniquely identified by peer IPv[46] address
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__neighbor_address','__config','__state','__timers','__transport','__error_handling','__logging_options','__ebgp_multihop','__route_reflector','__as_path_options','__add_paths','__afi_safis','__graceful_restart','__apply_policy','__use_multiple_paths',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__neighbor_address = YANGDynClass(base=ReferenceType(referenced_path='../config/neighbor-address', caller=self._path() + ['neighbor-address'], path_helper=self._path_helper, require_instance=True), is_leaf=True, yang_name="neighbor-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/bgp', defining_module='openconfig-bgp', yang_type='leafref', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'bgp', u'neighbors', u'neighbor']
...
group
  ...
  def _get_add_paths(self):
    """
    Getter method for add_paths, mapped from YANG variable /bgp/neighbors/neighbor/add_paths (container)
...
multiple paths for a single NLRI (add-paths)
  ...
  def _set_add_paths(self, v, load=False):
    """
    Setter method for add_paths, mapped from YANG variable /bgp/neighbors/neighbor/add_paths (container)
    If this variable is read-only (config: false) in the
...
NLRI when they are received only from this neighbor
  ...
  _pyangbind_elements = {'neighbor_address': neighbor_address, 'config': config, 'state': state, 'timers': timers, 'transport': transport, 'error_handling': error_handling, 'logging_options': logging_options, 'ebgp_multihop': ebgp_multihop, 'route_reflector': route_reflector, 'as_path_options': as_path_options, 'add_paths': add_paths, 'afi_safis': afi_safis, 'graceful_restart': graceful_restart, 'apply_policy': apply_policy, 'use_multiple_paths': use_multiple_paths, }
