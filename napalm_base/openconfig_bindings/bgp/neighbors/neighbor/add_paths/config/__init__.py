...
class config(PybindBase):
  ...
  from YANG module openconfig-bgp - based on the path /bgp/neighbors/neighbor/add-paths/config. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'bgp', u'neighbors', u'neighbor', u'add-paths', u'config']

  def _get_receive(self):
    """
    Getter method for receive, mapped from YANG variable /bgp/neighbors/neighbor/add_paths/config/receive (boolean)
...
for an NLRI from the neighbor or group
  ...
  def _set_receive(self, v, load=False):
    """
    Setter method for receive, mapped from YANG variable /bgp/neighbors/neighbor/add_paths/config/receive (boolean)
...
for an NLRI from the neighbor or group
  ...
  def _get_send_max(self):
    """
    Getter method for send_max, mapped from YANG variable /bgp/neighbors/neighbor/add_paths/config/send_max (uint8)
...
for a single NLRI
  ...
  def _set_send_max(self, v, load=False):
    """
    Setter method for send_max, mapped from YANG variable /bgp/neighbors/neighbor/add_paths/config/send_max (uint8)
    If this variable is read-only (config: false) in the
